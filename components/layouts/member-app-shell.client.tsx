      ...
      <aside className="hidden lg:flex lg:w-64 lg:flex-col border-r border-border bg-card/60">
        ...
        <div className="px-4">
          <div className="rounded-2xl border border-border bg-card/80 p-4">
            ...
            <p className="mt-1 text-sm font-semibold">{user?.name || user?.email || "Member"}</p>
        ...
        <div className="px-4 pb-6">
          ...
          >
            ...
            <p className="mt-2 text-base font-semibold">Turn on concierge boost to stay on top of your tribe.</p>
            <Link href="/premium" className="mt-4 inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 text-xs font-semibold uppercase tracking-wide">
